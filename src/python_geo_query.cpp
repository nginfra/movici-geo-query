...
PythonGeoQuery::PythonGeoQuery(const LocationArray &xy, const IndexArray &rowPtr,
                               const std::string &type)
{
    ...
    else
    {
        throw std::invalid_argument(
            "Input type: " + type + " unknown. Choose from " + accepted_input_types::point + ", " +
            accepted_input_types::linestring + ", " + accepted_input_types::openPolygon + " and " +
            accepted_input_types::closedPolygon + ".");
    }
}
